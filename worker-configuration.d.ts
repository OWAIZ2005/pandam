/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc` (hash: e7b731606529266cf0bb78ef60ad4e0e)
// Runtime types generated with workerd@1.20260908.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
  MEDIA: R2Bucket;
  DB: D1Database;
  PANDAM_ENV: 'development';
  SENTRY_DSN: string;
  POSTHOG_KEY: string;
  POSTHOG_HOST: string;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'PANDAM_ENV' | 'SENTRY_DSN' | 'POSTHOG_KEY' | 'POSTHOG_HOST'>
  > {}
}
